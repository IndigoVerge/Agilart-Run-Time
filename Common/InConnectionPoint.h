...
#ifndef INCONNECTIONPOINT_H_
#define INCONNECTIONPOINT_H_

#include "ConnectionPoint.h"
#include "IValueChanged.h"
#include "IRefreshValue.h"

class InConnectionPoint: public ConnectionPoint
{
	private:
	...
	public:
		InConnectionPoint( int, string, string, string, void* );
		InConnectionPoint( int, string, string, AgilartDataTypes, void* );
		virtual ~InConnectionPoint();
		...
		void (IValueChanged::*InValueChanged)(void* connPointPtr);
		...
		void RegisterRefreshHandler( IRefreshValue* handler );
		void Refresh();
};

#endif /* INCONNECTIONPOINT_H_ */
