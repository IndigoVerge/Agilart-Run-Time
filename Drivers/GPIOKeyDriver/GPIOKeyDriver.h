...
#ifndef GPIOKEYDRIVER_H_
#define GPIOKEYDRIVER_H_
...
class GPIOKeyDriver: public BaseDriver
{
	public:
		GPIOKeyDriver();
		virtual ~GPIOKeyDriver();
		...
		struct input_event ReadValue();
		void SetCurrentValue(struct input_event newValue);

		friend void* ReadKeyThreadRun( void* param );

	private:
		int fdKey;
		int nBytes;
		int keyCode;
		struct input_event currentStatus;
		bool shouldStop;
