...
#ifndef CONSTANTWIDGET_H_
#define CONSTANTWIDGET_H_

#include "BaseDevice.h"

class ConstantDevice : public BaseDevice
{
	public:
		ConstantDevice();
		virtual ~ConstantDevice();
